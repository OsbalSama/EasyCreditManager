...
import Dialogs.InsClient;
import Dialogs.RouteMappingD;
 ...
 * @author terra
 */
public final class AllRouteMappings extends javax.swing.JFrame {
    ...
    public AllRouteMappings() {
        ...
        modelo.addColumn("Cobrador asignado");
            ...
            public void mousePressed(MouseEvent Mouse_evt) {
                ...
                if (Mouse_evt.getClickCount() == 2) {
                    try {
                        ...
                        RouteMappingD rm = new RouteMappingD(null, true);
                        rm.setUpdateData(id);
                        rm.show();
                        actualizar_tabla();
                    } catch (Exception ex) {
    ...
    public void showClients() {
        modelo.setRowCount(0);
        String datos[] = new RouteMapping().getDBRouteMapping();
        try {
            if (datos != null) {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("MAPEOS DE RUTAS");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AllRouteMappings.class
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AllRouteMappings().setVisible(true);
            }
        });
    }
