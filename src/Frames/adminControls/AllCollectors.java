 ...
 * @author terra
 */
public final class AllCollectors extends javax.swing.JFrame {
            ...
            public void mousePressed(MouseEvent Mouse_evt) {
                if (Mouse_evt.getClickCount() == 2) {
                    try {
                        ...
                        InsCobr ic = new InsCobr(null, true);
                        ic.updateCollector(id);
                        ic.show();
                        actualizar_tabla();
                    } catch (Exception ex) {
    ...
    public void showCollectors() {
        modelo.setRowCount(0);
        String datos[] = new Cobradores().getDBCollectors();
        try {
            if (datos != null) {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("TODOS LOS COBRADORES");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AllCollectors.class
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AllCollectors().setVisible(true);
            }
        });
    }
